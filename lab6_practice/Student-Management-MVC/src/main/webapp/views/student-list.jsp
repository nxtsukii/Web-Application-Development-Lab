        ...
        <div class="container">
            ...
            <div class="filter-box" style="margin-bottom:20px;">
                <form action="student" method="get" style="display:flex; gap:10px; align-items:center;">
                    ...
                    <select name="major" style="padding:8px;">
                    ...
                    <!-- Clear filter only when user selected a major -->
            ...
            <div class="search-box" style="margin-bottom: 20px;">
                <form action="student" method="get" style="display: flex; gap: 10px; align-items: center;">
                    ...
                    <!-- Clear button (only appears when searching) -->
            ...
            <c:if test="${not empty keyword}">
                <div style="margin-bottom: 15px; font-size: 16px; color: #555;">
                    <strong>Search results for:</strong> "<em>${keyword}</em>"
                </div>
            </c:if>
