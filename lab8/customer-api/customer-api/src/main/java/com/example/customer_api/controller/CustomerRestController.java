...
public class CustomerRestController {
    ...
    // Advanced search w/ multiple criterias
    ...
    // Pagination
    @GetMapping("/page")
    public ResponseEntity<Map<String, Object>> getAllCustomersPaged(
    ...
    public ResponseEntity<List<CustomerResponseDTO>> getAllCustomersSorted(
        ...
        List<CustomerResponseDTO> customers = 
                customerService.getAllCustomers(sortBy, sortDir);
    ...
    public ResponseEntity<Map<String, Object>> getAllCustomersPagedAndSorted(
            @RequestParam(defaultValue = "0") int page,
            @RequestParam(defaultValue = "10") int size,
            @RequestParam(defaultValue = "fullName") String sortBy,
            @RequestParam(defaultValue = "asc") String sortDir) {
